...
export function trFifths(note, fifths) {
  ...
  const n = encodeNote(note);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (n === null) <span class="cstat-no" title="statement not covered" >return null;</span>
...
export function fifths(from, to) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length === 1) <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >to</span> =&gt; <span class="cstat-no" title="statement not covered" >fifths(from, to);</span></span>
  const f = encodeNote(from);
  const t = encodeNote(to);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (t === null || f === null) <span class="cstat-no" title="statement not covered" >return null;</span>
  return t[0] - f[0];
}
&nbsp;
/**
...
export function transposeBy(interval, note) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (arguments.length === 1) return n =&gt; transpose(n, interval);
<span class="cstat-no" title="statement not covered" >  return transpose(note, interval);</span>
}
&nbsp;
...
export function addIntervals(ivl1, ivl2, dir) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (i1 === null || i2 === null) <span class="cstat-no" title="statement not covered" >return null;</span>
...
export function subtract(ivl1, ivl2) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length === 1) <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >i2</span> =&gt; <span class="cstat-no" title="statement not covered" >add(ivl1, i2);</span></span>
  return addIntervals(ivl1, ivl2, -1);
}
&nbsp;
/**
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Nov 15 2018 06:50:53 GMT+0100 (CET)
</div>
</div>

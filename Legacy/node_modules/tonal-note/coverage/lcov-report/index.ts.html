...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">type NoteLetter = "A" | "B" | "C" | "D" | "E" | "F" | "G";
...
const memo = &lt;T extends string | number, V&gt;(
  fn: (s: T) =&gt; V,
  <span class="missing-if-branch" title="else path not taken" >E</span>cache = {} as { [key in T]: V }
 ...
 * Note.enhramonic("C") // =&gt; "C"
 */
export const enharmonic = <span class="fstat-no" title="function not covered" >(</span>note: Note) =&gt; <span class="cstat-no" title="statement not covered" >simplify(note, false);</span>
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Nov 15 2018 06:50:50 GMT+0100 (CET)
</div>
</div>

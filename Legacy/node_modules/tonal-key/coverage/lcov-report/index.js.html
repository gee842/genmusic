...
export const degrees = str =&gt; {
  const p = props(str);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (p.name === null) <span class="cstat-no" title="statement not covered" >return [];</span>
...
export const alteredNotes = name =&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (alt === null) <span class="cstat-no" title="statement not covered" >return null;</span>
  return alt === 0
...
export function leadsheetSymbols(symbols, keyName) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!p.name) <span class="cstat-no" title="statement not covered" >return [];</span>
...
export const relative = (mode, key) =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length === 1) <span class="cstat-no" title="statement not covered" >return <span class="fstat-no" title="function not covered" >ke</span>y =&gt; <span class="cstat-no" title="statement not covered" >relative(mode, key);</span></span>
  const num = modenum(mode.toLowerCase());
  <span class="missing-if-branch" title="if path not taken" >I</span>if (num === undefined) <span class="cstat-no" title="statement not covered" >return null;</span>
  const k = props(key);
  <span class="missing-if-branch" title="if path not taken" >I</span>if (k.name === null) <span class="cstat-no" title="statement not covered" >return null;</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Nov 15 2018 06:50:57 GMT+0100 (CET)
</div>
</div>

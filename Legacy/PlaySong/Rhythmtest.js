...
RhythmSample.prototype.play = function() {
  ...
  for (var bar = 0; bar < 2; bar++) {
    ...
    playRandomChord(chordkey,time,time+1.5* eighthNoteTime,context);

    playRandomChord(chordkey,time+2.5* eighthNoteTime,time+2.75* eighthNoteTime,context);
    playRandomChord(chordkey,time+3.5* eighthNoteTime,time+4* eighthNoteTime,context);


    playSound(this.kick, time);
    playSound(this.hihat, time + 0.5 * eighthNoteTime);
    playSound(this.hihat, time + 1 * eighthNoteTime);
    playSound(this.kick, time + 1.5 * eighthNoteTime);



    playSound(this.snare, time + 2 * eighthNoteTime);
    playSound(this.hihat, time + 2.5 * eighthNoteTime);
    playSound(this.hatopen, time + 3.0 * eighthNoteTime);
    playSound(this.kick, time + 3.5 * eighthNoteTime);



    playSound(this.hihat, time + 4.0 * eighthNoteTime);
    playSound(this.kick, time + 4.5 * eighthNoteTime);
    playSound(this.kick, time + 5.0 * eighthNoteTime);playSound(this.openhat, time + 5.0 * eighthNoteTime);
    playSound(this.hatopen, time + 5.5 * eighthNoteTime);
    ...
    playSound(this.snare, time + 7.5 * eighthNoteTime);

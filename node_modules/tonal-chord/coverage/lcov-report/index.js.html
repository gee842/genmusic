...
export const supersets = name =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!intervals(name).length) <span class="cstat-no" title="statement not covered" >return [];</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Nov 15 2018 06:51:04 GMT+0100 (CET)
</div>
</div>
